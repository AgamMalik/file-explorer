...
// following is function passed to create server used to create the server
const respond = (request, response) => {
    ...
    // get the corresponding full static path located in th e static folder
    ...
    if (stats.isDirectory()) {
        ...
        let data = fs.readFileSync(path.join(staticBasePath, 'project_files/index.html'));
    ...
    getMimeType(fileDetails.extname).then(mime => {
        ...
        // all other file? : stream  in normal way
        ...
        .catch(err => {
            ...
            response.write(`500: Internal seerver error!`);
